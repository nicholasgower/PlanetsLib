...
Players are welcome to edit the [tiers file on Github](https://github.com/danielmartin0/PlanetsLib/blob/main/tiers.lua) to update or introduce a tier value.
